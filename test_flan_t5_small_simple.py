"""Test FLAN-T5-small with simplified prompt."""
...
print("=" * 70)
print("FLAN-T5-SMALL Simplified Prompt Test")
print("=" * 70)
...
out_path = os.path.join("reports", "flan_t5_small_simple_prompt_10_examples.json")
