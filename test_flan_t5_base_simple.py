"""Test FLAN-T5-base with simplified prompt."""
...
print("=" * 70)
print("FLAN-T5-BASE Simplified Prompt Test")
print("=" * 70)
...
out_path = os.path.join("reports", "flan_t5_base_simple_prompt_10_examples.json")
