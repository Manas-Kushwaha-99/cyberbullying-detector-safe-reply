"""
Fine-tune flan-t5-small on CORRECTED de-escalatory reply data - STABLE VERSION.
Fixed: No fp16, lower LR, gradient clipping to prevent NaN.
"""
import os
import sys
...
print("=" * 60)
print("Fine-tuning FLAN-T5-small (Stable) for De-escalatory Reply Generation")
print("=" * 60)
...
# Training args - STABLE: no fp16, gradient clipping, lower LR
