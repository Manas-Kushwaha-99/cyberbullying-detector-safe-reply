"""Test FLAN-T5-base with strong prompt on manually preprocessed original dataset."""
...
print("=" * 70)
print("FLAN-T5-BASE Strong Prompt Test - 10 Cyberbullying Examples")
print("=" * 70)
...
# Strong prompt for FLAN-T5 (instruction-tuned)
...
print("\nGenerating replies with FLAN-T5-base...\n")
results = []
...
# Save results
out_path = os.path.join("reports", "flan_t5_base_10_examples.json")
