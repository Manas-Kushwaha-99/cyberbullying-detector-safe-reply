"""Test Gemma 3 1B 4-bit quantized with simplified prompt."""
...
print("=" * 70)
print("Gemma 3 1B (4-bit) Simplified Prompt Test")
print("=" * 70)
...
def generate_reply(message):
    ...
    # Extract only the reply part after the prompt
    if prompt in reply:
...
out_path = os.path.join("reports", "gemma3_1b_4bit_simple_prompt_10_examples.json")
